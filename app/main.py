...
#   timestamp: 2023-05-21T04:53:52+00:00
...
async def create_affiliate(body: CreateAffiliateRequest) -> None:
    """
    加盟組織作成API
    """
    h = injector.resolve(AffiliateHandler)
...
async def create_order(body: CreateOrderRequest) -> None:
    """
    注文作成API
    """
    h = injector.resolve(OrderHandler)
...
async def create_order_item(order_id: UUID, body: CreateOrderItemRequest = ...) -> None:
    """
    注文明細作成API
    """
    h = injector.resolve(OrderItemHandler)
...
async def create_purchase_right(body: CreatePurchaseRightRequest) -> None:
    """
    購入権作成API
    """
    h = injector.resolve(PurchaseRightHandler)
...
async def read_purchase_right(purchase_right_id: UUID) -> PurchaseRight:
    """
    購入権取得API
    """
    h = injector.resolve(PurchaseRightHandler)
...
async def create_user(body: CreateUserRequest) -> None:
    """
    ユーザ作成API
    """
    h = injector.resolve(UserHandler)
