...
#   timestamp: 2023-05-20T17:46:21+00:00
...
class FieldAffiliate(BaseModel):
    __root__: Any
...
class UserID(BaseModel):
    __root__: UUIDModel = Field(..., description='ユーザID')
...
class OrderItemID(BaseModel):
    __root__: UUIDModel = Field(..., description='注文明細ID')
...
class OrderID(BaseModel):
    __root__: UUIDModel = Field(..., description='注文ID')
...
class User(BaseModel):
    ...
    created_at: datetime = Field(..., description='作成日')
    updated_at: datetime = Field(..., description='更新日')
    affiliate: Optional[FieldAffiliate] = None
    orders: Optional[List[OrderID]] = None
