...
class Affiliate(BaseModel):
    ...
    users: Optional[List[BaseID]] = None
    orders: Optional[List[BaseID]] = None
    available_items: Optional[List[BaseID]] = None
...
class Item(BaseModel):
    ...
    created_at: datetime = Field(..., description='作成日')
    updated_at: datetime = Field(..., description='更新日')
    allowed_affiliates: Optional[List[BaseID]] = None
...
class Order(BaseModel):
    ...
    affiliate: Affiliate
    user: User
    items: Optional[List[BaseID]] = None
